...
<div className="table-responsive">
    <table className="table">
        <thead>
            <tr>
                <th>Team A Players List</th>
                <th>Team B Players List</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td><svg className="bi bi-shield-fill" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" style={{ fontSize:"23px", }}>
                        <path
